...
set J2ME_WSAPI=%LIB_DIR%\j2me-ws.jar
set J2ME_XMLRPC_API=%LIB_DIR%\j2me-xmlrpc.jar

set PREVERIFY=..\..\..\bin\preverify

set JAVA_FILES=
set JAVA_FILES=%JAVA_FILES% ..\src\example\serverscript\connector\*.java
set JAVA_FILES=%JAVA_FILES% ..\src\example\serverscript\demo\*.java
...
%JAVAC% -bootclasspath %CLDCAPI%;%MIDPAPI%;%J2ME_WSAPI%;%J2ME_XMLRPC_API% -source 1.3 -target 1.3 -d ..\tmpclasses -classpath ..\tmpclasses %JAVA_FILES%
...
%PREVERIFY% -classpath %CLDCAPI%;%MIDPAPI%;%JSR172API%;..\tmpclasses -d ..\classes ..\tmpclasses
